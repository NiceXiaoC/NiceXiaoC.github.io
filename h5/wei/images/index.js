...
function checkWinSize(){		//检测窗口大小
	...
	if(winWidth>winHeight){	//横屏
		...
		/*if(initState==0){		//初始化播放器
			document.getElementById('videoContainer').innerHTML='<video autoplay="autoplay" style="display:none;" loop="loop" id="myVideobox"><source src="images/bgsound.mp3"></video>';
