...
function mTween(obj, attrs, duration, fx, callback) {
    ...
    for (var attr in attrs) {
        ...
        if(attr == "opacity"){
        	if(obj.currentStyle){
        		j[attr].b = parseFloat(obj.currentStyle[attr]) || 100;
        	}else{
        		j[attr].b = parseFloat(getComputedStyle(obj)[attr]) || 100;
        	}
        }else{
        	j[attr].b = obj.currentStyle ? parseFloat(obj.currentStyle[attr]) : parseFloat(getComputedStyle(obj)[attr]);
        }
